...
char Simba::isWin(int pos) {
    ...
    // check horizontal
    far_left = (pos/10)*10;
    test_string = string(board.begin() + far_left, board.begin() + far_left + 9);
    //cout << test_string + "\n";
